    ...
    <Section id="blog" ref={element}>
      ...
      <div className="blogs">   
            ...
            >
              ...
              <div className="description">
                <p>개인프로젝트를 통해 <strong>React</strong> 에 대한 기존에 알고 있던 <strong>지식을 활용</strong> 하고 <strong>기능을 구현함</strong>으로써 <strong>개발 숙련도의 향상</strong>과 <strong>상태 관리의 중요성</strong> 을 다시 깊게 이해하기 위해서 시작 하였습니다. 또한 카페마다 감성을 담은 사진을 찍는것을 좋아하다보니 이것을 컨셉으로 해서 웹사이트를 만들면 좋을 것 같다는 생각으로 웹사이트를 개발하게 되었습니다.
                </p>
              </div>
              <div>주요 기능</div>
              <div>사진 업로드 및 글 작성 기능, 즐겨찾기 추가 기능</div>
              <a href='https://github.com/yonghk423/keep-memories'>
                <div>GitHub</div>
              </a>
              <a href='https://market-list-eight.vercel.app'>
                <div>URL</div>  
              </a>
              <div>Frontend</div>
              <div>TypeScript, React.js, React Hooks API, Redux.js, <br></br> Redux-Thunk, Axios, Sass(SCSS)</div>
              <div>Backend</div>
              ...
              <div className="more">
                <img src={play} alt="play" />
                <a href='https://velog.io/@yonghk423?tag=%EA%B0%9C%EC%9D%B8%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8'>
                  <span>자세히 보기</span>  
                </a>            
              </div>
              ...
              <div className="description">
                <p><strong>협업에서 중요한 소통과 맡은 역할에 대한 책임감</strong>을 느끼는 소중한 기회이자 경험이었습니다. 나랏말싸미는 우리말을 재밌게 배워 바르게 쓸 수 있도록 관련된 퀴즈를 제공하는 사이트입니다. 직접 퀴즈를 만들수 있으며 흥미를 유발하고 퀴즈를 풀고 맞춤에 따라 마일리지를 얻어 활용할 수 있는 즐거움을 배로 증가 시킬 것 입니다.
                </p>
              </div>
              <div>주요 기능</div>
              <div>퀴즈 만들기, 퀴즈 맞추기, 마일리지를 이용한 상품구매</div>
              <a href='https://github.com/codestates/TheKing-sLetters'>
                <div>GitHub</div>
              </a>
              <a href='https://thekingsletters.ml'>
                <div>URL</div>  
              </a>
              <div>Frontend</div>
              ...
              <div className="more">
                <img src={play} alt="play" />
                <a href='https://velog.io/@yonghk423?tag=4%EC%A3%BC-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8'>
                  <span>자세히 보기</span>  
                </a>            
              </div>
            </motion.div>    
